...
import { Home, BookOpen, ShoppingBag, ArrowLeftRight, DollarSign } from "lucide-react";
import { cn } from "@/lib/utils";

const navItems = [
  { href: "/", label: "Home", icon: Home },
  { href: "/album", label: "Álbum", icon: BookOpen },
  { href: "/banca", label: "Banca", icon: ShoppingBag },
  { href: "/trocas", label: "Trocas", icon: ArrowLeftRight },
  { href: "/financas", label: "$", icon: DollarSign },
];

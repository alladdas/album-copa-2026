...
/**
 * components/ui/chip.tsx — chip de filtro (status/seleção)
 */
...
export interface ChipProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  active?: boolean;
  leading?: string;   // cor da bolinha de status (CSS color or var)
  tone?: string;      // background quando ativo (default: --ink)
}
